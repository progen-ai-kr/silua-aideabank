...
// 하위 페이지에서도 홈과 같은 카테고리 및 하위 메뉴를 유지합니다.
if (menu && currentPageName !== "index.html") {
  menu.innerHTML = `
    <li class="gnb-category">
      <a href="products.html">SELF WEDDING</a>
      <ul class="gnb-submenu"><li><a href="products.html?mode=rental">대여</a></li><li><a href="products.html?service=custom">맞춤제작</a></li></ul>
    </li>
    <li class="gnb-category">
    ...
    <li class="gnb-category">
      ...
      <ul class="gnb-submenu"><li><a href="products.html?type=one-piece">원피스</a></li><li><a href="products.html?type=two-piece">투피스</a></li><li><a href="products.html?type=suit">수트</a></li></ul>
    </li>
    <li class="gnb-category">
...
const translations = {
  ko: {
    ...
    pages: {
      "index.html": { title: "SILUA — Silhouette of Beauty", heroTitle: "전통을 다시 입는 것이 아니라, 오늘의 나를 위한 새로운 선으로 입는다.", heroSub: "한복이 드레스가 되는 순간, 당신의 가장 빛나는 하루.", action: "컬렉션 보기", categoryTitles: ["Self Wedding", "Evening & Party", "Wedding Attire"], categories: ["인생의 주인공이 되는 날", "화려하게 빛나는 순간", "특별한 날의 레디투웨어"], categoryMore: "자세히 보기 >", strengths: "우리 브랜드의 강점", strengthTitle: "강점 제목", strengthBody: "강점 설명을 적으세요.", looks: "인기 상품", editorialTitle: "신 제품" },
      ...
      "products.html": { title: "컬렉션 — SILUA", head: "SILUA COLLECTION", intro: "이브닝·파티, 셀프웨딩, 스냅 웨딩드레스" },
  ...
  en: {
    ...
    pages: {
      "index.html": { title: "SILUA — Silhouette of Beauty", heroTitle: "Not tradition reworn, but new lines made for who I am today.", heroSub: "A hanbok becomes a dress for your brightest day.", action: "VIEW COLLECTION", categoryTitles: ["Self Wedding", "Evening & Party", "Wedding Attire"], categories: ["The day you become the main character", "A moment to shine brilliantly", "Ready-to-wear for your special day"], categoryMore: "VIEW MORE >", strengths: "WHY CHOOSE SILUA", strengthTitle: "STRENGTH TITLE", strengthBody: "Describe this strength here.", looks: "POPULAR PRODUCTS", editorialTitle: "NEW PRODUCTS" },
      ...
      "products.html": { title: "Collection — SILUA", head: "SILUA COLLECTION", intro: "Evening & party, self wedding, and wedding snap dresses" },
